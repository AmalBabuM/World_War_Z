...
public class RaycastWeapon : MonoBehaviour
{
    ...
    public static GameObject bullet4;//BULLET 4
    GameObject myCanvas;
    CurrentAmmo gunAmmo;
    ...
    {   
        ...
        gunAmmo=myCanvas.GetComponentInChildren<CurrentAmmo>();
        bullet1 = GameObject.FindWithTag("BUL1");
        bullet2 = GameObject.FindWithTag("BUL2");
        bullet3 = GameObject.FindWithTag("BUL3");
        bullet4 = GameObject.FindWithTag("BUL4");
